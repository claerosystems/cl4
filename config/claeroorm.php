...
return array(
	...
	'default_meta_data_field_type' => array(
		...
		'file' => array(
			...
			'field_options' => array(
				'file_options' => array(
					// see config/claerofile.php for a full list of options
				),
			),
		),
	),
	...
	'default_options' => array(
		...
		'get_form_view_file' => 'claero/orm_form_table', // the default view to use when displaying the edit or search form
		'get_view_view_file' => 'claero/orm_view_table', // the default view to use when displaying a view of a record
		'edit_multiple_view_file' => 'claero/orm_edit_multiple_table',
		...
		// todo: 'date_expired_column' => CLAERO_EDIT_EXPIRY_COLUMN,
