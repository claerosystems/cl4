...
if ($total_pages > 1) {
	if ($previous_page !== FALSE) {
		echo HTML::anchor($page->url($previous_page), __('Previous'), array('class' => 'previous')) . ' ';
	} else {
...
?>
	...
	<div class="cl4_nav_showing">Showing <?php echo $items_on_page; ?> of <?php echo $total_items; ?> items</div>
	<div class="clear"></div>
</div><!-- .pagination -->